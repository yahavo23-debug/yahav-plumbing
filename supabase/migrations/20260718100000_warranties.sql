-- מודול אחריות: מה הוחלף/הותקן אצל כל לקוח, תוקף אחריות ותעודת אחריות מצולמת
...
-- Bucket לתעודות אחריות (פרטי, גישה לצוות בלבד)
INSERT INTO storage.buckets (id, name, public) VALUES ('warranties','warranties', false) ON CONFLICT (id) DO NOTHING;
