    ...
    <div className="space-y-4">
      ...
      <Dialog open={shareDialogOpen} onOpenChange={setShareDialogOpen}>
        <DialogContent className="sm:max-w-md" dir="rtl">
          <DialogHeader>
            <DialogTitle>
              {shareMode === "sign" ? "שליחה לחתימה" : "שליחה לצפייה"} — הצעת מחיר #{shareQuoteNumber}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              {shareMode === "sign"
                ? "הקישור הבא מאפשר ללקוח לצפות בהצעת המחיר ולחתום עליה דיגיטלית."
                : "הקישור הבא מאפשר צפייה בלבד ללא אפשרות חתימה."}
            </p>
            ...
            <div className="flex gap-2">
              <Button onClick={handleCopyShareUrl} variant="outline" className="flex-1 gap-2">
