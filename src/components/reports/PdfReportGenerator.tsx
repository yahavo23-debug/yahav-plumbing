...
const LEGAL_DISCLAIMER = `תנאים והגבלת אחריות

העבודה בוצעה בהתאם למפורט בדוח זה בלבד ונבדקה במעמד סיום העבודה, ונמצאה תקינה וללא נזילה גלויה.

האחריות, ככל שניתנה, חלה אך ורק על המקטע שטופל בפועל במסגרת העבודה. לא תחול אחריות על תשתית קיימת, צנרת ישנה, או תקלות במקטעים סמוכים שלא טופלו.

במקרים של פתיחת סתימה – לא תינתן אחריות לחזרת הסתימה כאשר נגרמה כתוצאה משימוש לא תקין, השלכת פסולת, או כשל מבני בצנרת.

במקרה של איתור נזילות (ככל שבוצע) – השירות מהווה הערכה מקצועית בלבד, בהתאם לממצאים בשטח ולמגבלות הציוד, ואינו מהווה התחייבות לזיהוי מוחלט או ודאי של מקור הנזילה. ייתכן קיום מוקדי נזילה נוספים או סטייה במיקום בפועל.

הלקוח מתחייב לדווח באופן מיידי על כל תקלה. כל נזק שנגרם עקב עיכוב בדיווח או אי נקיטת פעולות למניעת החמרת הנזק – הינו באחריות הלקוח בלבד.

לא תחול אחריות לנזקים עקיפים, לרבות רטיבות, עובש, פגיעה ברכוש, ירידת ערך או כל נזק נלווה אחר הנובע ממצב התשתית או מאי טיפול בזמן.

עבודות סגירה, ככל שבוצעו, הינן בסיסיות בלבד ואינן כוללות עבודות גמר, צבע, התאמות גוון או שיקום אסתטי מלא, אלא אם צוין אחרת במפורש.

התמונות והסרטונים המצורפים מהווים חלק בלתי נפרד מהדוח עבודה גם בחתימה וגם בסופי לאחר חתימה וישמשו כראיה למצב התשתית ולביצוע העבודה בפועל.

כל התערבות, תיקון או שינוי שבוצע על ידי גורם אחר לאחר סיום העבודה – מבטל כל אחריות.`;
